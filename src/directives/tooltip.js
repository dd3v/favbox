export default {
  mounted(el, binding) {
    ...
    tooltip.className = 'tooltip bg-black text-white text-xs rounded shadow-md py-1 px-2 absolute whitespace-nowrap z-50 opacity-0 transition-opacity duration-300';
