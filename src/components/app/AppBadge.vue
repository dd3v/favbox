...
const badgeClass = computed(() => `badge-${props.color}`);
...
.close-button {
  @apply size-3 flex items-center justify-center;
}

.badge-red .close-button {
  @apply text-red-700 hover:bg-red-300/20 hover:text-red-900 dark:text-red-300 dark:hover:text-red-100;
}

.badge-yellow .close-button {
  @apply text-yellow-700 hover:bg-yellow-300/20 hover:text-yellow-900 dark:text-yellow-300 dark:hover:text-yellow-100;
}

.badge-green .close-button {
  @apply text-green-700 hover:bg-green-300/20 hover:text-green-900 dark:text-green-300 dark:hover:text-green-100;
}

.badge-cyan .close-button {
  @apply text-cyan-700 hover:bg-cyan-300/20 hover:text-cyan-900 dark:text-cyan-300 dark:hover:text-cyan-100;
}

.badge-indigo .close-button {
  @apply text-indigo-700 hover:bg-indigo-300/20 hover:text-indigo-900 dark:text-indigo-300 dark:hover:text-indigo-100;
}

.badge-purple .close-button {
  @apply text-purple-700 hover:bg-purple-300/20 hover:text-purple-900 dark:text-purple-300 dark:hover:text-purple-100;
}

.badge-pink .close-button {
  @apply text-pink-700 hover:bg-pink-300/20 hover:text-pink-900 dark:text-pink-300 dark:hover:text-pink-100;
}

.badge-gray .close-button {
  @apply text-gray-600 hover:bg-gray-300/20 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100;
}
</style>
