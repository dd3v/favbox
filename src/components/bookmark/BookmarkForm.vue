  ...
  <div class="space-y-3">
    ...
    >
      <div class="mt-1">
        ...
        >
          <ListboxOptions
            class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white text-xs shadow-lg ring-1 ring-black/5 focus:outline-none dark:bg-neutral-900 dark:text-neutral-400"
          >
            <ListboxOption
    ...
    >
      <legend class="text-xs text-black dark:text-white">
