...
<template>
  ...
  >
    <div class="absolute top-0 m-1">
      <button @click="refresh"><img src="@/assets/icons/icon128.png" class="mt-2 h-9 w-9" alt="logo"/></button>
    </div>
    <div
    ...
    <div class="absolute bottom-3 flex flex-col space-y-2">
      <button
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512" class="h-5 w-5 fill-gray-700 dark:fill-neutral-300">
            <path
        ...
        <button
          ...
          class="flex h-10 w-10 items-center justify-center rounded-md bg-white dark:bg-neutral-800"
        >
          <component :is="isDark ? SunIcon : MoonIcon" class="h-5 w-5 fill-gray-700 text-gray-700 dark:fill-neutral-300 dark:text-neutral-300" />
        </button>
    </div>
  </div>
</template>
